...
typedef AVIMMConfigContainer Config;
...
public:
    AVIMMFilterBase(const Vector &initial_state, const Matrix &transitions_matrix, const Matrix &covariance_matrix,
                           ...
                           const Matrix &control_input_matrix, const QString& filter_key) : m_filter_key(filter_key)
     {
...
protected:
    ...
    Vector expandErrorVector(const Vector &x)
    {
        ...
        new_x = Config::singleton().expansion_matrix * new_x;
        return new_x;
    }
