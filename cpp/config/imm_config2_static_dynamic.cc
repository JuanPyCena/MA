...
namespace static_config
{
    ...
    AVMatrix<float> expansion_matrix_covariance = [[    x; vx; y; vy; ax; ay;];
                                                   ...
                                                   [ax; 0;  0; 0;  0;  9;  0];
                                                   [y;  0;  0; 1;  0;  0;  0];
                                       markov_transition_matrix            [vy; 0;  0; 0;  1;  0;  0];
                                                   [ay; 0;  0; 0;  0;  0;  9]];
    ...
    namespace subfilters
    {
        ...
        namespace kf
        {
            ...
            //!
            //! \suggested []
            AVMatrix<float> covariance_matrix =
            [[   x; vx; ax; y; vy; ay;];
            [x;  1;  0;  0; 0;  0;  0];
            [vx; 0;  1;  0; 0;  0;  0];
            [ax; 0;  0;  1; 0;  0;  0];
...
namespace dynamic_config
{
    ...
    namespace ApproachEast
    {
        namespace kf
        {
            ...
            //!
            //! \suggested []
            AVMatrix <QString> &process_noise_matrix = Q_default
        } // namespace kf
        ...
        //!
        //! \suggested []
        AVMatrix<float> &markov_transition_matrix = markov_transition_matrix_default
    ...
    // -------------------------------------------------------------
    namespace ApproachWest : dynamic_config.ApproachEast {} // namespace ApproachWest
    
    // -------------------------------------------------------------
    namespace ApproachNorth: dynamic_config.ApproachEast {} // namespace ApproachWest
  
    // -------------------------------------------------------------
    namespace ApproachSouth : dynamic_config.ApproachEast {} // namespace ApproachWest
    
    // -------------------------------------------------------------
    namespace Apron : dynamic_config.ApproachEast {} // namespace Apron

} // namespace dynamic_config

AVMatrix <QString> Q_default =
[[               x;           vx;           ax;             y;           vy;          ay;];
...
AVMatrix<float> markov_transition_matrix_default =
[[         Filter1; Filter2;];
[Filter1;    0.95;     0.05];
[Filter2;    0.05;     0.95]];
