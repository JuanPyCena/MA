...
class TestbenchPlotter(object):
    ...
    def plot_imm_data(self):
        ...
        fig.tight_layout()
        plt.savefig(self.plot_name_imm_data + "_measurements", dpi=1200)
        plt.show()
        ...
        fig.tight_layout()
        plt.savefig(self.plot_name_imm_data + "_state", dpi=1200)
        plt.show()
        ...
        fig.tight_layout()
        plt.savefig(self.plot_name_imm_data + "_mode", dpi=1200)
        plt.show()
        ...
        fig.tight_layout()
        plt.savefig(self.plot_name_imm_data + "_errors", dpi=1200)
        plt.show()
